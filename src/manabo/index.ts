...
export {
    ...
    type ManaboClassContentIconDTO,
    type ManaboClassContentDurationDTO,
    type ManaboClassContentFileDTO,
    type ManaboClassContentActionDTO,
    type ManaboClassContentAttachedFileDTO,
    type ManaboClassContentContentDTO,
    type ManaboClassFileContentDTO,
    type ManaboClassReportContentDTO,
